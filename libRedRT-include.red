...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_ctx||263~on-change*: "f_ctx||263~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||263~on-deep-change*: "f_ctx||263~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||269~on-change*: "f_ctx||269~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||267~on-change*: "f_ctx||267~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||267~on-deep-change*: "f_ctx||267~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||290~lex: "f_ctx||290~lex" [octx [pointer! [integer!]]] 
            f_ctx||310~encode: "f_ctx||310~encode" [octx [pointer! [integer!]]] 
            f_ctx||310~decode: "f_ctx||310~decode" [octx [pointer! [integer!]]] 
            f_ctx||319~BOM-UTF-16?: "f_ctx||319~BOM-UTF-16?" [octx [pointer! [integer!]]] 
            f_ctx||319~BOM-UTF-32?: "f_ctx||319~BOM-UTF-32?" [octx [pointer! [integer!]]] 
            f_ctx||319~enquote: "f_ctx||319~enquote" [octx [pointer! [integer!]]] 
            f_ctx||319~high-surrogate?: "f_ctx||319~high-surrogate?" [octx [pointer! [integer!]]] 
            f_ctx||319~low-surrogate?: "f_ctx||319~low-surrogate?" [octx [pointer! [integer!]]] 
            f_ctx||319~translit: "f_ctx||319~translit" [octx [pointer! [integer!]]] 
            f_ctx||319~decode-backslash-escapes: "f_ctx||319~decode-backslash-escapes" [octx [pointer! [integer!]]] 
            f_ctx||319~encode-backslash-escapes: "f_ctx||319~encode-backslash-escapes" [octx [pointer! [integer!]]] 
            f_ctx||319~decode-unicode-char: "f_ctx||319~decode-unicode-char" [octx [pointer! [integer!]]] 
            f_ctx||319~replace-unicode-escapes: "f_ctx||319~replace-unicode-escapes" [octx [pointer! [integer!]]] 
            f_ctx||319~push: "f_ctx||319~push" [octx [pointer! [integer!]]] 
            f_ctx||319~pop: "f_ctx||319~pop" [octx [pointer! [integer!]]] 
            f_ctx||319~emit: "f_ctx||319~emit" [octx [pointer! [integer!]]] 
            f_load-json: "f_load-json" [octx [pointer! [integer!]]] 
            f_ctx||335~init-state: "f_ctx||335~init-state" [octx [pointer! [integer!]]] 
            f_ctx||335~emit-indent: "f_ctx||335~emit-indent" [octx [pointer! [integer!]]] 
            f_ctx||335~emit-key-value: "f_ctx||335~emit-key-value" [octx [pointer! [integer!]]] 
            f_ctx||335~red-to-json-value: "f_ctx||335~red-to-json-value" [octx [pointer! [integer!]]] 
            f_to-json: "f_to-json" [octx [pointer! [integer!]]] 
            f_ctx||343~encode: "f_ctx||343~encode" [octx [pointer! [integer!]]] 
            f_ctx||343~decode: "f_ctx||343~decode" [octx [pointer! [integer!]]] 
            f_ctx||348~to-csv-line: "f_ctx||348~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||348~escape-value: "f_ctx||348~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||348~next-column-name: "f_ctx||348~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||348~make-header: "f_ctx||348~make-header" [octx [pointer! [integer!]]] 
            f_ctx||348~get-columns: "f_ctx||348~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||348~encode-map: "f_ctx||348~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||348~encode-maps: "f_ctx||348~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||348~encode-flat: "f_ctx||348~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||348~encode-blocks: "f_ctx||348~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||361~on-change*: "f_ctx||361~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||364~on-change*: "f_ctx||364~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||364~on-deep-change*: "f_ctx||364~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||369~add-relation: "f_ctx||369~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||369~eval: "f_ctx||369~eval" [octx [pointer! [integer!]]] 
            f_ctx||369~eval-reaction: "f_ctx||369~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||369~pending?: "f_ctx||369~pending?" [octx [pointer! [integer!]]] 
            f_ctx||369~check: "f_ctx||369~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||369~is~: "f_ctx||369~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||384~alpha-num+: "f_ctx||384~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||384~parse-url: "f_ctx||384~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||390~do-quit: "f_ctx||390~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||390~throw-error: "f_ctx||390~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||390~syntax-error: "f_ctx||390~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||390~do-safe: "f_ctx||390~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||390~do-code: "f_ctx||390~do-code" [octx [pointer! [integer!]]] 
            f_ctx||390~count-args: "f_ctx||390~count-args" [octx [pointer! [integer!]]] 
            f_ctx||390~arg-mode?: "f_ctx||390~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||390~func-arity?: "f_ctx||390~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||390~value-path?: "f_ctx||390~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||390~fetch-next: "f_ctx||390~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||390~eval: "f_ctx||390~eval" [octx [pointer! [integer!]]] 
            f_ctx||390~do-macro: "f_ctx||390~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||390~register-macro: "f_ctx||390~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||390~reset: "f_ctx||390~reset" [octx [pointer! [integer!]]] 
            f_ctx||390~expand: "f_ctx||390~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx||426~tail-idx?: "f_ctx||426~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||426~push-color: "f_ctx||426~push-color" [octx [pointer! [integer!]]] 
            f_ctx||426~pop-color: "f_ctx||426~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||426~close-colors: "f_ctx||426~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||426~push: "f_ctx||426~push" [octx [pointer! [integer!]]] 
            f_ctx||426~pop: "f_ctx||426~pop" [octx [pointer! [integer!]]] 
            f_ctx||426~pop-all: "f_ctx||426~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||426~optimize: "f_ctx||426~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||424~line-height?: "f_ctx||424~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||424~line-count?: "f_ctx||424~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||446~on-deep-change*: "f_ctx||446~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||450~on-change*: "f_ctx||450~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||450~on-deep-change*: "f_ctx||450~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||454~on-change*: "f_ctx||454~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||457~on-change*: "f_ctx||457~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||460~capture-events: "f_ctx||460~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||460~awake: "f_ctx||460~awake" [octx [pointer! [integer!]]] 
            f_ctx||469~init: "f_ctx||469~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||479~Cancel-OK: "f_ctx||479~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx||477~process: "f_ctx||477~process" [octx [pointer! [integer!]]] 
            f_ctx||475~throw-error: "f_ctx||475~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||475~process-reactors: "f_ctx||475~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||475~calc-size: "f_ctx||475~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||475~align-faces: "f_ctx||475~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||475~resize-child-panels: "f_ctx||475~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||475~clean-style: "f_ctx||475~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||475~process-draw: "f_ctx||475~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||475~pre-load: "f_ctx||475~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||475~add-option: "f_ctx||475~add-option" [octx [pointer! [integer!]]] 
            f_ctx||475~add-flag: "f_ctx||475~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||475~fetch-value: "f_ctx||475~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||475~fetch-argument: "f_ctx||475~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||475~fetch-expr: "f_ctx||475~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||475~fetch-options: "f_ctx||475~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||475~make-actor: "f_ctx||475~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx||294~encode: "ctx||294~encode" [img [red-image!] where [cell!]] 
            ctx||294~decode: "ctx||294~decode" [data [cell!]] 
            ctx||298~encode: "ctx||298~encode" [img [red-image!] where [cell!]] 
            ctx||298~decode: "ctx||298~decode" [data [cell!]] 
            ctx||302~encode: "ctx||302~encode" [img [red-image!] where [cell!]] 
            ctx||302~decode: "ctx||302~decode" [data [cell!]] 
            ...
            ctx||469~make-null-handle: "ctx||469~make-null-handle" [] 
            ctx||469~get-screen-size: "ctx||469~get-screen-size" [id [integer!]] 
            ctx||469~size-text: "ctx||469~size-text" [face [red-object!] value [cell!]] 
            ctx||469~on-change-facet: "ctx||469~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||469~update-font: "ctx||469~update-font" [font [red-object!] flags [integer!]] 
            ctx||469~update-para: "ctx||469~update-para" [face [red-object!] flags [integer!]] 
            ctx||469~destroy-view: "ctx||469~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||469~update-view: "ctx||469~update-view" [face [red-object!]] 
            ctx||469~refresh-window: "ctx||469~refresh-window" [h [red-handle!]] 
            ctx||469~redraw: "ctx||469~redraw" [face [red-object!]] 
            ctx||469~show-window: "ctx||469~show-window" [id [red-handle!]] 
            ctx||469~make-view: "ctx||469~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||469~draw-image: "ctx||469~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||469~draw-face: "ctx||469~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||469~do-event-loop: "ctx||469~do-event-loop" [no-wait? [logic!]] 
            ctx||469~exit-event-loop: "ctx||469~exit-event-loop" [] 
            ctx||469~request-font: "ctx||469~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx||469~request-file: "ctx||469~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx||469~request-dir: "ctx||469~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx||469~text-box-metrics: "ctx||469~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||469~update-scroller: "ctx||469~update-scroller" [scroller [red-object!] flags [integer!]] 
    ...
    lexer: context [
        #import [libRedRT-file stdcall [
                scan: "red/lexer/scan" [dst [cell!] src [pointer! [byte!]] size [integer!] one? [logic!] scan? [logic!] load? [logic!] wrap? [logic!] len [pointer! [integer!]] fun [red-function!] ser [red-series!] return: [integer!]] 
                scan-alt: "red/lexer/scan-alt" [dst [cell!] str [red-string!] size [integer!] one? [logic!] scan? [logic!] load? [logic!] wrap? [logic!] len [pointer! [integer!]] fun [red-function!] return: [integer!]]
            ]]
    ] 
    none: context [
        #import [libRedRT-file stdcall [
